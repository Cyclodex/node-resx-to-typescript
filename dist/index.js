...
var nestedResources = true;
function executeResxToTs(typeScriptResourcesNamespace, virtualResxFolder, virtualTypeScriptFolder, generateNestedResources) {
    if (generateNestedResources === void 0) { generateNestedResources = true; }
...
function executeResxToJson(virtualResxFolder, virtualJsonFolder, fileNameLanguage, generateNestedResources) {
    if (generateNestedResources === void 0) { generateNestedResources = true; }
    nestedResources = generateNestedResources;
    var files = getFilesFromFolder(virtualResxFolder);
    if (files !== undefined && files !== null) {
